    ...
    <div>
      <div className="w-12 h-screen bg-second flex justify-center drop-shadow-md shadow-slate-700 fixed z-50">
        <ul className="flex flex-col items-center mt-5">
          ...
          <li
            className="mt-auto mb-5 hover:cursor-pointer hover:bg-third p-1 rounded-full hover:rounded hover:p-2 transition ease-in-out duration-500"
            onClick={Logout}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className={props.createClass}>
        <div
          className="fixed z-50 w-32 h-14 right-7 bottom-5 bg-white shadow-2xl shadow-black rounded-full flex items-center hover:bg-slate-500 transition duration-300 hover:cursor-pointer text-blue-700 hover:text-white z-49"
