...
const Group = () => {
  ...
  const renderOption = (data) => {
    return data.map((item, index) => {
      return (
        <option key={index} value={item.id} selected={major[0].id === classData.major_id}>
          {item.name}
        </option>
      );
    });
  ...
  const selectedOption = (param, data) => {
    {
      return param == data ? "selected" : "";
    }
  };
      ...
      <div className="mx-auto my-4 w-48">
        ...
        <div className="sm:col-span-3 mt-6 mb-8">
          ...
          <div className="mt-2">
            <select
              ...
              className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
              onChange={({ target }) => changeDropDown(target)}
              value={major.id == classData.major_id}
            >
              <option>-- Choose Major --</option>
              {renderOption(major)}
            </select>
        ...
        <div className="mt-6 mb-8">
          ...
          <div className="mt-2">
            ...
            >
              <option>-- Choose Class --</option>
              <option value="X" selected={classData.class === "X"}>X</option>
              <option value="XI" selected={classData.class === "XI"}>XI</option>
              <option value="XII" selected={classData.class === "XII"}>XII</option>
            </select>
          </div>
        </div>
        <div className="sm:col-span-3 mt-6 mb-8">
          ...
          <div className="mt-2">
            ...
            >
              <option>-- Choose Grade --</option>
              <option value="A" selected={classData.grade === "A"}>A</option>
              <option value="B" selected={classData.grade === "B"}>B</option>
              <option value="C" selected={classData.grade === "C"}>C</option>
              <option value="D" selected={classData.grade === "D"}>D</option>
              <option value="E" selected={classData.grade === "E"}>E</option>
            </select>
          </div>
        </div>
        <div className="mt-6 mb-8">
      ...
      <div className="w-screen h-screen flex overflow-y-hidden">
        ...
        <div className="flex flex-col" id="cardList">
          ...
          <div className="w-screen flex flex-col mt-[46rem]" id="secondCard">
            ...
            />
            <div
              className="ml-16 flex justify-center mt-10 rotate-180"
              onClick={arrowUp}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
